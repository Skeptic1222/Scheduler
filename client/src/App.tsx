            ...
            <div className="space-y-4">
              ...
              <div className="w-full">
                ...
                <Button 
                  ...
                  className="w-full h-12 bg-white hover:bg-gray-50 text-gray-700 border border-gray-300 shadow-sm flex items-center justify-center space-x-3 mt-2"
                ...
                >
                  {isGoogleLoading ? (
                    ...
                    <>
                      ...
                      <span className="text-sm font-medium">Setup Google Sign-In</span>
                    </>
                  )}
                </Button>
              </div>
